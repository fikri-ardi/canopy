    ...
    <main class="space-y-6 px-4 py-5 sm:px-6 sm:py-6 lg:px-8">
        <section class="summary-grid">
            ...
            <div class="metric-card metric-card-savings group cursor-pointer" wire:click="openSavingsDetail" id="savings-rate-card">
                ...
                <div class="mt-1.5 flex items-center gap-1.5 text-[11px] font-medium text-gray-400 dark:text-slate-500" wire:loading.remove wire:target="setCategoryChartPeriod,selectInvestment,labelActivityYear">
            ...
            <div class="metric-card">
                <div class="flex items-start justify-between gap-3">
                    ...
                    <span class="{{ $remainingBalance < 0 ? 'inline-flex size-10 shrink-0 items-center justify-center rounded-lg bg-red-50 text-red-600 ring-1 ring-red-100 dark:bg-red-500/10 dark:text-red-300 dark:ring-red-500/20' : 'icon-box-muted' }}" wire:loading.remove wire:target="setCategoryChartPeriod,selectInvestment,labelActivityYear">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.7" stroke="currentColor" class="size-5">
        ...
        >
            ...
            <div wire:loading.remove wire:target="setCategoryChartPeriod">
            ...
            <div class="mt-4 space-y-4" wire:loading wire:target="setCategoryChartPeriod">
                <div class="bg-green-50/45 px-4 py-4 dark:bg-green-500/[0.06] rounded-xl sm:px-5 sm:py-5">
                    <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                        <div class="space-y-2">
                            <div class="h-3 w-16 skeleton rounded"></div>
                            <div class="h-6 w-40 skeleton rounded"></div>
                            <div class="h-3 w-28 skeleton rounded"></div>
                            <div class="h-4.5 w-32 skeleton rounded mt-2"></div>
                        </div>
                    ...
                    <div class="mt-5 h-[18rem] rounded bg-gray-50/50 dark:bg-slate-900/50 flex flex-col justify-between p-4 relative overflow-hidden">
                        <div class="h-full w-full flex items-end justify-between gap-3">
                            <div class="h-1/4 w-full skeleton rounded"></div>
                            <div class="h-1/2 w-full skeleton rounded"></div>
                            <div class="h-3/4 w-full skeleton rounded"></div>
                            <div class="h-1/3 w-full skeleton rounded"></div>
                            <div class="h-2/3 w-full skeleton rounded"></div>
                            <div class="h-4/5 w-full skeleton rounded"></div>
                            <div class="h-3/5 w-full skeleton rounded"></div>
                        </div>
                    </div>
                </div>
            </div>
