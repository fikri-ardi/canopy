    ...
    <div class="modal-panel">
        ...
        <form class="mt-5 space-y-5" wire:submit="store">
            ...
            <div class="flex justify-end gap-2">
                <button type="button" x-on:click="createExpense = false" wire:loading.attr="disabled" wire:target="store" class="btn-secondary">Batal</button>
                <button type="submit" wire:loading.attr="disabled" wire:target="store" class="btn-primary inline-flex items-center gap-2" data-onboarding-target="expense-create">
                    <span wire:loading wire:target="store" class="spinner text-white"></span>
                    <span wire:loading.remove wire:target="store">Tambah Pengeluaran</span>
