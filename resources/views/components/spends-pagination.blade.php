@if ($paginator->hasPages())
    ...
    <nav role="navigation" aria-label="Pagination pengeluaran" class="panel flex flex-col gap-3 px-3 py-3 sm:flex-row sm:items-center sm:justify-between sm:px-4">
        ...
        <div class="flex items-center justify-between gap-2 sm:justify-end">
            <button
                ...
                data-tooltip="Halaman sebelumnya"
            >
            ...
            <button
                ...
                data-tooltip="Halaman berikutnya"
            >
